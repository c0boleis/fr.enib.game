...
public class SchemaEditorMenuBar extends JMenuBar
{
	...
	public SchemaEditorMenuBar(final BasicGraphEditor editor)
	{
		...
		menu.add(editor.bind(mxResources.get("saveAs"), new SaveAction(true),
				"/fr/enib/game/editor/graphe/examples/swing/images/saveas.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("pageSetup"),
				new PageSetupAction(),
				"/fr/enib/game/editor/graphe/examples/swing/images/pagesetup.gif"));
		...
		menu.add(editor.bind(mxResources.get("cut"), TransferHandler
				.getCutAction(), "/fr/enib/game/editor/graphe/examples/swing/images/cut.gif"));
		menu.add(editor
				...
				.add(editor
						.bind(
								...
								new StylesheetAction(
										"/fr/enib/game/editor/graphe/examples/swing/resources/basic-style.xml")));
		submenu
				.add(editor
						.bind(
