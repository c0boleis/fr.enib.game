...
import fr.enib.game.editor.graphe.shape.mxActorShape;
import fr.enib.game.editor.graphe.shape.mxArrowShape;
import fr.enib.game.editor.graphe.shape.mxCloudShape;
import fr.enib.game.editor.graphe.shape.mxConnectorShape;
import fr.enib.game.editor.graphe.shape.mxCurveShape;
import fr.enib.game.editor.graphe.shape.mxCylinderShape;
import fr.enib.game.editor.graphe.shape.mxDefaultTextShape;
import fr.enib.game.editor.graphe.shape.mxDoubleEllipseShape;
import fr.enib.game.editor.graphe.shape.mxDoubleRectangleShape;
import fr.enib.game.editor.graphe.shape.mxEllipseShape;
import fr.enib.game.editor.graphe.shape.mxHexagonShape;
import fr.enib.game.editor.graphe.shape.mxHtmlTextShape;
import fr.enib.game.editor.graphe.shape.mxIShape;
import fr.enib.game.editor.graphe.shape.mxITextShape;
import fr.enib.game.editor.graphe.shape.mxImageShape;
import fr.enib.game.editor.graphe.shape.mxLabelShape;
import fr.enib.game.editor.graphe.shape.mxLineShape;
import fr.enib.game.editor.graphe.shape.mxRectangleShape;
import fr.enib.game.editor.graphe.shape.mxRhombusShape;
import fr.enib.game.editor.graphe.shape.mxStencilRegistry;
import fr.enib.game.editor.graphe.shape.mxSwimlaneShape;
import fr.enib.game.editor.graphe.shape.mxTriangleShape;
