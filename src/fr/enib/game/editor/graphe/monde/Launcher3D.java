 ...
 *
 */
public class Launcher3D extends JFrame implements GLEventListener, MouseListener, MouseMotionListener, KeyListener{
	private static final long serialVersionUID = 1L;
	private static Logger LOGGER = Logger.getLogger(Launcher3D.class);
    ...
    /**
     * fix la souris, appuyer sur escape pour metre a false
     */
	 ...
	 */
	public Launcher3D(boolean loadfromFile) {
		super(TITLE);
